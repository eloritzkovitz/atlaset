...
The **`Currencies`** section gives you a detailed list of currencies, showing both their `names` and their `ISO 4217 code`. Each currency shows a detailed view, including which countries or territories use that currency.

Currencies can be searched and filtered by name and code.
